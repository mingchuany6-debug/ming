...
public class MainActivity extends Activity {
    ...
    private void buildUi(){
        ...
        TextView title=label("高德酒店采集助手 2.2.0",27);title.setTextColor(Color.rgb(17,135,82));title.setGravity(Gravity.CENTER_HORIZONTAL);root.addView(title);
        TextView sub=label("搜索结果卡片直读版｜匹配酒店 → 直接读取“2023年开业 | 101间房”",15);sub.setGravity(Gravity.CENTER_HORIZONTAL);root.addView(sub);
